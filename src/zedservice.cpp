...
void zedservice::startposeservice(std::string svo_files)
{

	zedservice::getCurZedservice()->startposeservice(svo_files);
}
...
std::string zedservice::startmergereportavi(std::string hmavi_file, std::string zedsvo_file, std::string zedposeavi_file, std::string posedata_file)
{


	return zedservice::getCurZedservice()->startmergereportavi(hmavi_file, zedsvo_file, zedposeavi_file, posedata_file);
}
...
{
	return zedservice::getCurZedservice()->getpose_avi_File();
}
